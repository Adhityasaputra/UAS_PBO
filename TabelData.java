...
public class TabelData extends javax.swing.JFrame {
    ...
    public void dataHandphone(){
        ...
        try {
            ...
            String query = "SELECT * FROM tbdatahandphone";
    ...
    public void loadData() {
        try {
            ...
            while (resultSet.next()) {
                ...
                row[2] = resultSet.getString("processor");
                row[3] = resultSet.getString("ram");
                row[4] = resultSet.getString("memori_internal");
                row[5] = resultSet.getInt("tahun_rilis");
                model.addRow(row);
            }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Object processor = dataTable.getValueAt(selectedRow, 2);
        Object ram = dataTable.getValueAt(selectedRow, 3);
        Object memori_internal = dataTable.getValueAt(selectedRow, 4);
        Object tahun_rilis = dataTable.getValueAt(selectedRow, 5);
        try {
            String query = "UPDATE tbdatahandphone SET merk = ?, processor = ?, ram = ?, memori_internal = ?, tahun_rilis = ? WHERE id = ?";
            PreparedStatement statement = connection.prepareStatement(query);

            statement.setString(1, merk.toString());
            statement.setString(2, processor.toString());
            statement.setString(3, ram.toString());
            statement.setString(4, memori_internal.toString());
            statement.setInt(5, Integer.parseInt(tahun_rilis.toString()));
    ...
    private void txtcariKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtcariKeyTyped
        ...
        try{
            String query = "Select * from tbdatahandphone where merk like '%" + txtcari.getText() + "%'";
